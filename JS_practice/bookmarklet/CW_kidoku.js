...
*/
javascript:(function(){
	var button_setting = document.getElementById("_chatRoomSetting").getElementsByClassName('sc-dREXXX')[0];
	button_setting.click();
	var toRead = function(){
		var button_toRead = document.getElementsByClassName('sc-hcmgZB')[0];
		button_toRead.click();
	}
